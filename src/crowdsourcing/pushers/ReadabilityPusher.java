...
import crowdsourcing.tasks.TranslationReadabilityTask;
 ...
 */
public class ReadabilityPusher {
  ...
  public void publishHITs(List<ReadabilityTask> designs) {
	  ...
	  for (int i = 0; i < designs.size(); i++) {
		  ...
		  String design = designs.get(i).getDesign();
...
//	  System.out.println("Word Count: " + readability.getWordCount());
  ...
  public static void main(String[] args) {
    ReadabilityPusher app = new ReadabilityPusher();
    List<ReadabilityTask> tasks = TranslationReadabilityTask.getTasks(3);
